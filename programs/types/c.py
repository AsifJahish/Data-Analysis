...
#According to the example above, transform mpg to L/100km in
# the column of "highway-mpg" and change the name of column to "highway-L/100km".
...
# normalization  to make it from 0 to 1
